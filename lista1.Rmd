...
Comparando com o modelo da área em $km^2$ sendo explicado pelo ano, tínhamos $Y = 523001.71 -258.76 \cdot X$, ou seja, a variável explicativa foi multiplicada por 100 e coeficientes do modelo também.
<br>
...
```
Daí temos que o $\lambda = 1.636364$, com o intervalo de confiança não contendo o zero por pouco.
...
Sabendo que o intervlo é dado por,
...
IP <- list(dados$viscosidade - EP, dados$viscosidade + EP)
dados$viscosidade - EP
```
...
```
<br>
Lambda foi igual a 0.7070, o intervalo contém o zero, no entanto será usado lambda = 0.707 pelo baixo tamanho da amostra.
<br>
