...
&emsp;&emsp; (c) Ajuste uma reta de regressão de superfície agrícola utilizada sobre anos. Discuta o significado dos par^metros da reta ajustada, no contexto do problema sob estudo;
...
&emsp;&emsp; (h) Calcule a Soma de Quadradis dis Resíduos (SQE), diretamente a partir dos resíduos, e verifique numericamente a relação fundamental da Regressão Linear: $SQT = SQReg + SQE$;
